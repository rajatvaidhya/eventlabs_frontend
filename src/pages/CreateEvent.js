...
const CreateEvent = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div style={{color:toggleLightMode?'black':'white', backgroundColor:toggleLightMode?'white':'black', minHeight:'100vh', overflowY:'scroll'}}>
      ...
      <div className="main-modal-container">
            ...
            >
              <label>
                <i
                  ...
                  style={{ fontSize: "2rem", color:toggleLightMode?"black":'white'}}
                ></i>
              </label>
        ...
        <div className="fill-room-details">
          <input
            ...
            style={{backgroundColor:toggleLightMode?'white':"", border:toggleLightMode?'1px solid #b9b9b9':''}}
            value={eventName}
          ...
          <div className="address-field">
            <div style={{ display: "flex", alignItems: "center" }}>
              <input
                style={{ width: "100%", backgroundColor:toggleLightMode?'white':"", border:toggleLightMode?'1px solid #b9b9b9':'' }}
                type="text"
                ...
                <div className="address-list">
                  <ul>
                    {addressList.map((item) => (
                      <li
                        key={item.osm_id}
                        style={{border:toggleLightMode?'1px solid #b9b9b9':'1px solid white'}}
                        onClick={() =>
                          handleListItemClick(
                            item.lat,
                            item.lon,
          ...
          <div className="mt-4 flex justify-end pb-10">
            <button onClick={handleCancelEvent} className="mr-4">Cancel</button>
            <button onClick={handleCreateEvent} className="create-button" style={{color:'white', backgroundColor: toggleLightMode?'rgb(255, 68, 79)':'rgb(11, 196, 67)'}}>
              Create
            </button>
          </div>
        </div>
